...
export const themes: Record<ThemeMode, { name: string; colors: ThemeColors }> = {
  ...
  cool: {
    ...
    colors: {
      ...
      accent: '#3A7BD5',
      accentSubtle: 'rgba(58,123,213,0.10)',
      accentLight: 'rgba(58,123,213,0.18)',
      border: 'rgba(107,122,143,0.15)',
      separator: 'rgba(107,122,143,0.08)',
      success: '#2AAA6A',
      successSubtle: 'rgba(42,170,106,0.12)',
      warning: '#E0A020',
      warningSubtle: 'rgba(224,160,32,0.12)',
      error: '#E05050',
      errorSubtle: 'rgba(224,80,80,0.12)',
    },
  },
  // 清新绿主题
  green: {
